...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/25 14:16:16 by jinchen           #+#    #+#             */
/*   Updated: 2026/02/01 17:46:32 by jinchen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	find_max_and_push_b(t_lst *lst, t_stack *st_a, int size)
{
	int	i;
	int	is_tail;
...
void	find_max_and_push_a(t_lst *lst, t_stack *st_b, int size)
{
	int	i;
	int	is_tail;
